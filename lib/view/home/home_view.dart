        ...
        return Scaffold(
          ...
          body: RefreshIndicator(
            onRefresh: () async {
              ...
              context
                  .read<HomeViewModel>()
                  .forceRefreshRandomHighlight(context);
            },
            child: ListView(
              children: [
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: RichText(
                                text: TextSpan(
                              text: profileViewModel.isAmharic
                                  ? "ሰላም\n"
                                  : "Hello\n",
                              style: TextStyle(
                              ...
                              children: [
                                TextSpan(
                                  text:
                                      profileViewModel.currentUser?.fullName ??
                                          '',
                                  style: TextStyle(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            showDialog(
                              ...
                              builder: (context) => FullScreenImageModal(
                                imageUrl: viewModel.randomHighlightPost!.media
                                        .url.isNotEmpty
                                    ? viewModel.randomHighlightPost!.media.url
                                    : 'assets/images/image.png',
                                title: viewModel.randomHighlightPost!
                                            .description?.isNotEmpty ==
                                        true
                                    ? viewModel
                                        .randomHighlightPost!.description!
                                    : (profileViewModel.isAmharic
                                        ? "የሳምንቱ ዋና መልእክት"
                                        : "Weekly Highlight"),
                              ),
                          ...
                          child: Container(
                            ...
                            child: viewModel
                                    .randomHighlightPost!.media.url.isNotEmpty
                                ? Image.network(
                                    viewModel.randomHighlightPost!.media.url,
                                    fit: BoxFit.cover,
                                    errorBuilder:
                          ...
                          onTap: () {
                            showDialog(
                              ...
                              builder: (context) => FullScreenImageModal(
                                ...
                                title: profileViewModel.isAmharic
                                    ? "የሳምንቱ ዋና መልእክት"
                                    : "Weekly Highlight",
                              ),
                            );
                        ...
                        child: Container(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                profileViewModel.isAmharic
                                    ? "ሀኪሞትን በተመቾት ሰዓት እና ቀን ለማማከር ቀጠሮ ይያዙ።"
                                    : "Book an appointment with our experts to get personalized advice.",
                              ),
                              SizedBox(
                                height: 10.0,
                              ),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                profileViewModel.isAmharic
                                    ? "የተመረጡ ጥያቄዎችን በመመለስ ስለእርግዝና ያሎትን እውቀት ይፈትሹ!"
                                    : "Play our trivia game to test your knowledge and learn new things.",
                              ),
                              SizedBox(
                                height: 10.0,
                              ),
                ...
                Container(
                  ...
                  child: ListView.builder(
                    shrinkWrap: true,
                    itemCount: viewModel.blogs
                        .sublist(0, (viewModel.blogs.length / 2).toInt())
                        .length,
                ...
                Container(
                  ...
                  child: ListView.builder(
                    shrinkWrap: true,
                    itemCount: viewModel.blogs
                        .sublist((viewModel.blogs.length / 2).toInt(),
                            viewModel.blogs.length)
                        .length,
                    scrollDirection: Axis.horizontal,
                    padding: EdgeInsets.all(5.0),
                    itemBuilder: (context, index) => PremiumContentContainer(
                      image: viewModel.blogs[index +
                          (viewModel.blogs.length / 2).toInt()]["media"]["url"],
                      title: viewModel.blogs[index +
                          (viewModel.blogs.length / 2).toInt()]["title"],
                      content: viewModel.blogs[index +
                          (viewModel.blogs.length / 2).toInt()]["content"],
                    ),
                  ),
                ),
